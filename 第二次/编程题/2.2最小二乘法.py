...
def last_square_current_loss(xs, ys, A):
    ...
    return error
# 迭代解法：最小二乘法+梯度下降法
def last_square_fit_curve_Gradient(xs, ys, order, iternum=100, learn_rate=0.001):
    A = [0.0] * (order + 1)
...
if __name__ == '__main__':
    ...
    # 迭代解法：最小二乘法+梯度下降
    A = last_square_fit_curve_Gradient(xs=xs, ys=ys, order=order, iternum=10000, learn_rate=0.00001)
